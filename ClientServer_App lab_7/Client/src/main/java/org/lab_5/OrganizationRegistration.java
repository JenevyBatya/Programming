...
//Handling organization's name
            ...
            return new Organization(name, new Coordinates(xCoordinates, yCoordinates), LocalDate.now(), annualTurnover, fullName, employeeCount, OrganizationType.valueOf(organizationType), new Address(street, new Location(xLocation, yLocation, zLocation)));
