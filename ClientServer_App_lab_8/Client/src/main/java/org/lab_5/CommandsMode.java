...
import org.lab_5.Gui.ThreeSectionFrame;
...
public class CommandsMode {
    ...
    public void executeCommand(BufferedReader input, PrintWriter output) throws IOException, JSchException, SQLException {
        ...
        System.out.println(commandExecute1);
        ThreeSectionFrame commandMode = new ThreeSectionFrame(commandExecute1.getHashtable(), input, output, null);
...
//                        commandExecute1 = receptionReader.read(message);
